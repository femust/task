...
Filter filter;
filter.set_filter(EdgeDetectionMethod::Laplace4);

    //setup the detector
//    FocusStacking executor;
//    executor.debug(true);
//    executor.setEdgeDetectionMethod(FocusStacking::EdgeDetectionMethod::Laplace8);

//    //load the images
////    for (auto it=images.begin();it<images.end();it++)
////    {
////        executor.addInputImage(*it);
////    }
